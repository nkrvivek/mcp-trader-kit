...
describe("traderkit stdio integration", () => {
  ...
  it("lists all tools", async () => {
    ...
    expect(names).toEqual(["aggregate_analyst_reports", "backtest_signals", "broker_route", "calc_max_pain", "calc_roll", "check_concentration", "check_trade", "check_wash_sale", "classify_holding", "classify_trade_outcome", "combo_fillability", "discover_flow", "earnings_calendar", "expiry_priority", "explain_payoff", "fetch_flow", "fetch_oi_changes", "flow_analysis", "fmp_fundamentals", "inst_holdings", "list_profiles", "macro_overlay", "monitor_position", "performance_metrics", "propose_trade", "reconcile_reminder", "reflect_trades", "regime_gate", "report_trades", "repricing_check", "risk_debate_3stance", "rvi_gap", "scan_tlh", "screen_options", "session_write", "set_profile", "signal_rank", "synthesize_debate", "thesis_fit", "track_activists", "track_tax", "trading_calendar", "trigger_check", "verify_fill"]);
  });
